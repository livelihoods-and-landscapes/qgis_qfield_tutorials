...
You will need the community map form loaded onto your mobile device. The community map form is a QGIS project and associated database where spatial and attribute data is recorded **(community-map-form_qfield.qgs)**. The QGIS project can be downloaded [here](https://github.com/livelihoods-and-landscapes/QConut-community-map/raw/master/community-map-blank-form.zip). 
