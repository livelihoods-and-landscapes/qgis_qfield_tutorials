...
Finally, you need to set up the form to enter data into *many_records*. Go to the *Properties* then *Attribute Form* of *many_records*. First, setup the foreign key *fk_field* as a *Relation Reference* widget. Make sure you uncheck the *Editable* checkbox. 
